...
export default function Home() {
  ...
  return (
    <main className="flex-1 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 sm:space-y-8 animate-fadeIn">
              {/* Region Badge */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-slate-900/80 border border-slate-800 rounded-full text-xs font-bold text-sky-400 tracking-wider shadow-sm">
              ...
              <div className="w-full max-w-md flex flex-col gap-3.5 pt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 w-full">
                  ...
                  <CTAButton
                    ...
                    className="w-full py-4 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl border border-slate-800 flex items-center justify-center gap-2 shadow-lg transition-all hover:scale-[1.01]"
                  >
                  ...
                  <CTAButton
                    ...
                    trackParams={{ cta_position: "hero_primary" }}
                    className="w-full py-4 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-green-950/20 transition-all hover:scale-[1.01]"
                  >
      ...
      {/* 3. Kaohsiung / Pingtung GEO Section */}
