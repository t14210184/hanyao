...
export default function ErvClient() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-slate-900/20 border border-slate-850 p-8 rounded-2xl text-center max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-md mx-auto">
              ...
              <CTAButton
                href="/contact/"
                className="w-full sm:flex-1 py-3.5 bg-slate-855 hover:bg-slate-800 text-white font-bold rounded-xl border border-slate-800 flex items-center justify-center gap-2 text-xs sm:text-sm transition-all"
              >
                <span>預約全熱交換器規劃</span>
              </CTAButton>
            </div>
