        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            <div className="bg-slate-900/20 border border-slate-850 p-5 rounded-xl hover:border-slate-800 transition-colors">
              <h3 className="text-sm font-semibold text-white mb-2">常識與故障自助排查</h3>
              <ul className="space-y-2 text-xs">
                <li>
                  <Link href="/guides/ac-not-cold/" className="text-sky-400 hover:underline flex items-center gap-1">
                    <span>冷氣不冷怎麼辦？</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
                <li>
                  <Link href="/guides/ac-leaking-water/" className="text-sky-400 hover:underline flex items-center gap-1">
                    <span>冷氣漏水怎麼辦？</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
            ...
            <div className="bg-slate-900/20 border border-slate-850 p-5 rounded-xl hover:border-slate-800 transition-colors">
              <h3 className="text-sm font-semibold text-white mb-2">專業檢修服務細項</h3>
              <ul className="space-y-2 text-xs">
                <li>
                  <Link href="/services/ac-repair/not-cold/" className="text-sky-400 hover:underline flex items-center gap-1">
                    <span>冷氣不冷檢修服務</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
                <li>
                  <Link href="/services/ac-repair/leaking-water/" className="text-sky-400 hover:underline flex items-center gap-1">
                    <span>冷氣漏水檢修服務</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
