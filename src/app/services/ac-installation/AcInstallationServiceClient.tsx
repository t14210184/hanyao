        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-slate-900/20 border border-slate-850 p-6 rounded-xl hover:border-slate-800 transition-colors">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">費用考量與評估指南</h3>
              <ul className="space-y-2 text-lg sm:text-xl font-semibold">
                <li>
                  <Link href="/guides/ac-installation-cost-factors/" className="py-2.5 flex items-center gap-1 text-sky-400 hover:text-sky-300 transition-colors">
                    <span>冷氣安裝費用受哪些因素影響？</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
                <li>
                  <Link href="/services/ac-installation/cost/" className="py-2.5 flex items-center gap-1 text-sky-400 hover:text-sky-300 transition-colors">
                    <span>冷氣安裝費用流程</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
            ...
            <div className="bg-slate-900/20 border border-slate-850 p-6 rounded-xl hover:border-slate-800 transition-colors">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">安裝類型與服務項目</h3>
              <ul className="space-y-2 text-lg sm:text-xl font-semibold">
                <li>
                  <Link href="/services/ac-installation/replacement/" className="py-2.5 flex items-center gap-1 text-sky-400 hover:text-sky-300 transition-colors">
                    <span>冷氣舊換新安裝</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
                <li>
                  <Link href="/services/ac-installation/split-ac/" className="py-2.5 flex items-center gap-1 text-sky-400 hover:text-sky-300 transition-colors">
                    <span>分離式冷氣安裝</span>
                    <span>&rarr;</span>
                  </Link>
                </li>
