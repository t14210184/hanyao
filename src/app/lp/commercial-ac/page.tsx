...
export default function CommercialAcLP() {
  ...
  // Synchronize with URL query parameter or window geo change event
  useEffect(() => {
  ...
  // Dynamic titles and metadata based on selected area
  const getAreaName = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "年度維護合約是透過每季或半年的定期巡檢、耗材與電容預防性汰換、冷媒管路氣密檢測，提前在小故障惡化前進行排障（例如發現風扇馬達電流異常、電容膨脹、冷媒微漏等）。這能降低無預警故障停機率，維護主能效，有效節省企業電費。"
    },
    {
      id: "comm-faq-5",
