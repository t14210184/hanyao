        ...
        <article className="py-16 bg-slate-950 flex-1">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <header className="mb-10 text-center sm:text-left">
              ...
              {/* Core conclusion box (First 50-word conclusion) */}
            ...
            <div className="space-y-10 text-xs sm:text-sm text-slate-400 leading-relaxed">
              ...
              <section className="space-y-4 pt-6 border-t border-slate-900">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    ...
                    <p className="text-slate-400 text-xs sm:text-sm">答：不一定。冷氣不冷最常見的原因是濾網髒污、冷凝器卡灰塵導致風阻過大，或是室外機散熱空間被雜物阻擋。如果是漏冷媒，必須先找出漏水點焊接修補，否則只加冷媒依然會反覆漏光，且容易導致壓縮機過載燒毀。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：自行清洗濾網後，冷氣還是不冷該怎麼辦？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：如果濾網乾淨、室外機通風良好卻仍只吹送風，可能是壓縮機啟動電容損壞、主控板受損或冷媒管路微漏。建議先關閉電源，拍照或錄製冷氣運轉聲音，LINE 傳給專業師傅協助初步分析。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：技師到府檢查冷氣不冷一般會做哪些項目？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：我們會進行系統性的查檢，包含出風口溫差量測、壓縮機運轉電流測量、冷媒高低壓壓力檢測、控制訊號線與基板診斷，並觀察鰭片髒污程度，依現場狀況與檢測數據向您說明最合適的處理方式。</p>
                  </div>
                </div>
              </section>
              ...
              <div className="pt-6 text-center space-y-6">
                ...
                <div className="flex justify-center gap-6 text-xs text-sky-400 font-semibold">
                  ...
                  <a href="/services/ac-repair/" className="hover:underline">變頻冷氣檢修服務頁 &rarr;</a>
                </div>
              </div>
