...
export default function AcSmellCleaningGuidePage() {
  ...
  // FAQ Schema (Only matches visible FAQs on page)
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "不一定。若只是防塵濾網上有灰塵，自行清洗濾網即可改善；但若異味來自蒸發器內部鰭片、深處的水盤或風鼓（鼓風輪）上的黴菌與果凍狀生物膜，則需要專業人員使用高壓清洗機搭配無毒藥劑進行深層清洗才能改善。"
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "不一定。最常見的原因是風鼓與濾網卡滿灰塵與棉絮，阻擋了出風氣流，清洗後通常可恢復風速。但也有可能是室內風扇馬達軸承磨損導致轉速變慢、啟動電容老化衰退、或是控制板訊號故障，需要到府進行現場診斷。"
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "需要。室外機長期置於室外，冷凝鰭片容易累積塵垢、寵物毛髮或落葉。當散熱鰭片被嚴重堵塞時，主機散熱不良會使壓縮機高溫過載而跳機，同時提高耗電量。清洗室外機有助於恢復散熱效率，達到省電目的並延長壓縮機壽命。"
        }
      },
      {
        "@type": "Question",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-10 text-slate-300 text-sm sm:text-base leading-relaxed">
              ...
              <section className="space-y-4">
                ...
                <p>
                  如果您的冷氣有異味但出風完全是常溫（主機沒在運轉）、清洗後過幾天依然滴水、或者出風口完全沒有風吹出，這可能代表不僅是髒污問題，而是線路、冷媒系統或馬達硬體有所磨損故障。此時建議由專業技師安排實地查檢與評估，找出核心病因後對症下藥。
                </p>
              </section>
              ...
              <div className="pt-6 text-center space-y-6">
                ...
                <div className="flex justify-center gap-6 text-xs text-sky-400 font-semibold">
                  <a href="/lp/ac-cleaning/" className="hover:underline">冷氣清洗廣告專區 &rarr;</a>
                  <a href="/services/ac-cleaning/" className="hover:underline">變頻冷氣清洗服務 &rarr;</a>
                  <a href="/faq/" className="hover:underline">常見保養問題 &rarr;</a>
                </div>
              </div>
              ...
              <section className="space-y-6 pt-10 border-t border-slate-900">
                ...
                <div className="space-y-6 max-w-3xl mx-auto">
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    ...
                    <p className="text-slate-400 text-xs sm:text-sm">答：不一定。若只是防塵濾網上有灰塵，自行清洗濾網即可改善；但若異味來自蒸發器內部鰭片、深處的水盤或風鼓（鼓風輪）上的黴菌與果凍狀生物膜，則需要專業人員使用高壓清洗機搭配無毒藥劑進行深層清洗才能改善。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：冷氣風量變小一定是髒污嗎？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：不一定。最常見的原因是風鼓與濾網卡滿灰塵與棉絮，阻擋了出風氣流，清洗後通常可恢復風速。但也有可能是室內風扇馬達軸承磨損導致轉速變慢、啟動電容老化衰退、或是控制基板訊號故障，需要到府進行現場診斷。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：可以只清室內機嗎？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：可以。室內機是主要的冷風出口與熱交換器，冷氣發霉、有霉味、粉塵飛散或滴水問題大都與室內機有關。若預算有限，可優先清洗室內機；但若室外機鰭片堆積大量塵土落葉影響散熱，仍建議一併施作。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：室外機也需要清洗嗎？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：需要。室外機長期置於室外，冷凝鰭片容易累積塵垢、寵物毛髮或落葉。當散熱鰭片被嚴重堵塞時，主機散熱不良會使壓縮機高溫過載而跳機，同時提高耗電量。清洗室外機有助於恢復散熱效率，達到省電目的並延長壓縮機壽命。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：清洗和維修怎麼判斷？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：若冷氣運轉功能正常且有冷風，但伴隨霉味、出風量變小或出風口滴水，通常只需進行「清洗保養」。若冷氣完全無法啟動、電源燈閃爍報錯誤代碼、只吹送風（壓縮機沒動，完全無冷度）、或機器運作時發出金屬撞擊等劇烈噪音，則屬於「維修檢修」範圍。</p>
                  </div>
                  <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                    <h3 className="font-bold text-white mb-2">Q：可以先 LINE 傳照片確認嗎？</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">答：可以。建議將室內機的正面外觀、掀開面板後的濾網狀況、出風口內部鰭片或風鼓的特寫照片，以及室外機的安裝環境拍照上傳至我們的官方 LINE，技師可協助進行初步的機型確認與施作評估。</p>
                  </div>
                </div>
              </section>
