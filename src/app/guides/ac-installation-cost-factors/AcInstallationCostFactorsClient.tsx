      ...
      <article className="py-16 bg-slate-950 flex-1">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-10 text-center sm:text-left">
            ...
            {/* Core conclusion */}
            <div className="mt-6 p-4 rounded-xl bg-slate-900/60 border border-slate-855 text-xs sm:text-sm text-slate-300 leading-relaxed">
          ...
          <div className="space-y-10 text-xs sm:text-sm text-slate-450 leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-decimal pl-5 space-y-2">
                <li><strong>室室內空間照片：</strong>拍攝欲安裝冷氣的房間正面與預期掛機的位置，以利判斷高度與散熱。</li>
            ...
            <section className="space-y-4 pt-6 border-t border-slate-900">
              ...
              <div className="space-y-4">
                <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                  ...
                  <p className="text-slate-450 text-xs sm:text-sm">答：因為每戶住家的梁柱結構、配電盤位置、室外機吊掛的危險程度（是否需要吊車或高空雙鉤作業）以及銅管所需的長度皆不相同。為了保證施工用電安規與日後不漏水，我們堅持依現場條件與實際需求進行量測評估，絕不以電話直接開死價，防止施作時產生後續糾紛。</p>
                </div>
                <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                  <h3 className="font-bold text-white mb-2">Q：裝潢前，為什麼要先找空調技師場勘？</h3>
                  <p className="text-slate-450 text-xs sm:text-sm">答：因為冷媒配管與冷凝水排水坡度必須隱藏在木工吊頂天花板內。在木工進場前預先到場放樣配置管線、預留維修孔位置，能與裝潢設計師流暢套圖，避免完工後冷氣滴水或氣流死角而無法修改天花板。</p>
                </div>
                <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-850">
                  <h3 className="font-bold text-white mb-2">Q：可以先在 LINE 上進行初步的估價諮詢嗎？</h3>
                  <p className="text-slate-455 text-xs sm:text-sm">答：可以。您可以先提供室內格局平面圖、安裝房間的實際照片、以及預計擺放室外機的陽台或外牆照片。我們的技師可以在官方 LINE 上為您進行線上初步判斷與機型配置建議，隨後再安排排程到府進行最終實地確認。</p>
                </div>
              </div>
            </section>
