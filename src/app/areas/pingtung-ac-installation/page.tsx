    ...
    <>
      ...
      <main className="flex-1 flex flex-col pt-16">
            ...
            <div className="mt-16 text-center max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-2.5 max-w-xl mx-auto mb-6">
                {districts.map((dst, idx) => (
                  <span 
                    key={idx}
                    className="text-xs py-1.5 px-3.5 bg-slate-900/60 border border-slate-850 text-slate-350 rounded-lg"
                  >
                    {dst}
                  </span>
                ))}
        ...
        <FinalCTA 
          ...
          onPhoneClick={() => trackEvent("lp_cta_click", { service_type: "ac_installation_pingtung", cta_position: "final_cta", lead_method: "phone" })}
          onLineClick={() => trackEvent("lp_cta_click", { service_type: "ac_installation_pingtung", cta_position: "final_cta", lead_method: "line" })}
        />
      </main>
    </>
  );
