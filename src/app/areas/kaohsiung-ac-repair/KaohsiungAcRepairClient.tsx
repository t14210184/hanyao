      ...
      <section className="py-16 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-xs text-slate-455 mt-2">冷氣異常若強行運轉，易導致压缩機負載過大而燒毀，建議儘早安排檢測。</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {symptoms.map((sym, idx) => (
              <div key={idx} className="bg-slate-900/30 border border-slate-850 p-6 rounded-2xl flex flex-col justify-between hover:border-slate-800 transition-colors shadow-md">
                ...
                <CTAButton
                  href="/contact/"
                  className="w-full text-center py-2 bg-slate-855 hover:bg-sky-500 text-white font-semibold rounded-lg border border-slate-800 hover:border-sky-500 text-xs transition-colors"
                >
                  預約高雄檢修
                </CTAButton>
              </div>
