...
test("HQ06 user identifiers are bounded, deduplicated, normalized and raw PII is rejected", () => {
  const candidates = [
    { type: "EMAIL_SHA256", hash: EMAIL_HASH.toUpperCase() },
    { type: "EMAIL_SHA256", hash: EMAIL_HASH },
    { type: "PHONE_SHA256", hash: PHONE_HASH },
    { type: "EMAIL_SHA256", hash: "person@example.com" },
    { type: "PHONE_SHA256", hash: "0912345678" },
...
test("HQ06 snapshot seal blocks later and backdated-late identifiers from retry payloads", async () => {
